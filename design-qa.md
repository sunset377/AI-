...
- 简历知识库：目标岗位、专业技能、7 个项目、应用与服务经历、教育、荣誉和证书均已按两页简历核对；旧版“AI 漫剧导演 / 视觉设计”主定位已替换。
- 回答优化：提示词要求先给结论，再给项目证据与岗位价值；技术边界、不足和资料缺失均需诚实说明，禁止为了提高好感虚构事实。
- 静态降级：GitHub Pages 返回 HTML 或 404 时切换到明确标注的“简历知识库演示模式”，常见面试问题仍可对话；Cloudflare 可用时自动恢复流式 AI。
