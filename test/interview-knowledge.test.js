...
test('resume knowledge base preserves the verified target role and project evidence', () => {
  ...
  assert.equal(resumeKnowledgeBase.education.graduation, '2026年6月')
...
test('interview prompt optimizes truthful answers for hiring conversations', () => {
  ...
  assert.match(interviewSystemPrompt, /本人直接确认的2026年6月/)
  assert.doesNotMatch(interviewSystemPrompt, /2027年/)
  assert.doesNotMatch(interviewSystemPrompt, /毕业月份：尚待本人确认/)
